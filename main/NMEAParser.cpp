...
{ 
	this->isvalid = false;
	this->checksumIsCalculated = false;
	this->calculatedChecksum = 0;
	this->parsedChecksum = 0;
}
...
bool NMEASentence::checksumOK() const {
	return (this->checksumIsCalculated)
		&&
		(this->parsedChecksum == this->calculatedChecksum);
}
...
{ 
	this->log = false;
	this->maxbuffersize = NMEA_PARSER_MAX_BUFFER_SIZE;
